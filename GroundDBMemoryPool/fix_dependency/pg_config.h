...
#define CONFIGURE_ARGS " '--prefix=/home/guo777/postgresql_built_project' 'LDFLAGS=-std=c++17 -lstdc++ -lrocksdb -lthrift -lrt -ldl -lsnappy -lgflags -lz -lbz2 -llz4 -lzstd -lrocksdb  -lpthread -I. -I/usr/local/include -I/usr/include -L/usr/local/lib -L/usr/bin'"
...
#define PG_VERSION "13.0"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 130000

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 13.0 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
