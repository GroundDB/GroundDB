...
#define mempool_client_sync_pat_lock (&mempool_client_lw_lock[1])
#define mempool_client_version_map_lock (&mempool_client_lw_lock[2])
#define mempool_client_pat_lock (&mempool_client_lw_lock[3])
